...
def index():
    ...
    return render_template('public/index.html',price_btc=price_btc,price_eth=price_eth)
...
def login():
    ...
    if form.validate_on_submit():
        if form.email.data =='CoinCorner@gmail.com' and form.password.data == "PASS??word123":
...
def predir_eth():
    ...
    # Obtenir le prix actuel du Eth via une API
    url = 'https://pro-api.coinmarketcap.com/v1/cryptocurrency/quotes/latest'
    headers = {'X-CMC_PRO_API_KEY': "4116c941-a133-4abf-b6c4-bd6cb321b499"}
